...
<body>
    ...
    <div class="container-sm">
        <form action="<?php echo base_url()."index.php/dashboard/proses_edit/".$id_lagu;?>" method="POST">
            <p class="h3">Edit</p>
            <input type="hidden" name="id_user" value="<?php echo $this->session->userdata('id_user'); ?>" class="form-control">
            <div class="form-row">
                <div class="col-3">
                    <label>Judul</label>
            ...
            <div class="form-row">
                <div class="col-3">
                    <label>Album</label>
                    <input type="text" name="album" value="<?php echo $album ?>" class="form-control">
                </div>
            </div>
            <br>
        ...
        <br>
        <form action="<?php echo base_url()."index.php/dashboard/hapus/".$id_lagu;?>">
